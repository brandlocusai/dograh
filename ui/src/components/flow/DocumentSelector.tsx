                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="text-xs text-muted-foreground">
                                            {formatFileSize(doc.file_size_bytes)} • {doc.retrieval_mode === 'full_document' ? 'Full Document' : doc.retrieval_mode === 'knowledge_graph' ? `${doc.total_chunks} entities (Graph)` : `${doc.total_chunks} chunks`}
                                        </div>
                                    </div>
                                </label>
                            </div>
